...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub SetCalendarStartDate(theDate as Date)
		  // Prefills the selected date shown
		  Date_Time_Container1.Calendar_Container1.Calendar1.SetCustomCalendarStartDate(theDate)
